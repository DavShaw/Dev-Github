...
def Start_pag_add_product():
    ...
    button_8 = Button(ProductFrame, text="Añadir", image=config_img_add, background=config_bgcolor, borderwidth=0, command=boton8)#Button añadir
    button_8.grid(row=6,column=2, padx=25, pady=10)

    text7 = Label(ProductFrame, text="", font=(config_font_type,0), background=config_bgcolor) #Text that shows last item added
