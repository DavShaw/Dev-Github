...
#Imagen GMAIL
imagen_gmail=Image.open(TakeFiles("logo_gmail.png"))
...
Label(ventana, text="Email",fg="white",bg="blue",font=("Arial", 10,"bold"),padx=5,pady=5).grid(row=2,column=0,columnspan=2,pady=5)
...
def enviar_email():
    global remitente
    remitente = "dcdparqueadero@gmail.com"
    #Estrutura de email
    email = EmailMessage()
    ...
    smtp.login(remitente, "123dcd123")
