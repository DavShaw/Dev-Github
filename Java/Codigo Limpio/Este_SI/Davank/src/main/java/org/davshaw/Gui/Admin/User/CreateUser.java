...
public class CreateUser extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(40, 40, 40)
                .addComponent(middleNameField, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 39, Short.MAX_VALUE)
                .addComponent(firstLastnameField, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(36, 36, 36)
                .addComponent(middleLastnameField, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(38, 38, 38)
    ...
    private void createUserButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createUserButtonActionPerformed
        ...
        //Creating user
        ResultPack<Boolean> result = UserController.createUser(dni, name1, name2, lastname1, lastname2, password);

        String message = String.format("User created successfully: %s\nServer return: %s\nMessage: %s", result.getOkay(), result.getResult(), result.getMessage());
        if(result.getOkay() == true)
        {
            JOptionPane.showMessageDialog(this, message, "Create User", JOptionPane.INFORMATION_MESSAGE);
        }
        else
        {
            JOptionPane.showMessageDialog(this, message, "Create User", JOptionPane.WARNING_MESSAGE);
        }
